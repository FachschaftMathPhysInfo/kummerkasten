...
func SeedData(ctx context.Context, db *bun.DB) error {
	...
	qAPs := []*models.QuestionAnswerPair{
		...
		{Question: "Wer ist der Kummerkasten?", Answer: "Eine kleine Teilmenge der Fachschaft MathPhysInfo.", Position: 2},
		{Question: "Wofür ist der Kummerkasten nicht da?", Answer: "Persönliche und mentale Probleme im Studium, Stress mit Kommilitonen", Position: 3},
		{Question: "Wie werden meine Daten verarbeitet?", Answer: "Dein Feedback landet vollkommen anonym bei uns im System, und wir kümmern uns in unserem Team darum dieses auszuwerten und mit allen benötigten Parteien zu bereden.", Position: 4},
	}
