...
for i in 0..50
Course.create(name:Faker::Company.catch_phrase,semester:Semester.offset(rand(Semester.count)).first,coursetype:Coursetype.offset(rand(Coursetype.count)).first,faculty:Faculty.offset(rand(Faculty.count)).first)
end
puts "Hier"
for i in 0..30
...
for i in 0..100
Complaint.create(message:Faker::Lorem.sentence,title:Faker::Hacker.abbreviation,approved:[true, false].sample,course:Course.offset(rand(Course.count)).first)
