...
export function TicketCard({ticketID}: TicketProps) {
    ...
    return (
        <Card className="w-full">
            <CardTitle className="flex ml-4 justify-between">
                ...
                <div className="flex flex-col items-end">
                    <div className="hidden md:flex md:mr-1">
                        {ticketLabels?.map((label) => (
                            label?.id && <Badge key={label.id} className="md:mx-1 text-white"
            ...
            <SeperatorHorizontal className="hidden md:flex mx-4"/>
            <CardContent className="flex">
                <div>
                    <div className="bold text-md">{ticket?.text}</div>
                </div>
            </CardContent>
